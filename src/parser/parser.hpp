...
#line 117 "src/parser/parser.hpp"
...
#line 143 "src/parser/parser.hpp"
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VAL", "ID", "'='",
  "'+'", "'-'", "'*'", "'/'", "'%'", "$accept", "S", YY_NULLPTR
};
...
#line 1118 "src/parser/parser.hpp"
